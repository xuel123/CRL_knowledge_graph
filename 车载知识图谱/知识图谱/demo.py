...
CreateNodesBySheetNums(6)
#subclassRelationship(workSheetName[4],"故障类型","故障设备类别")
#subclassRelationship(workSheetName[6],"设备型号","故障类型")
subclassRelationship(workSheetName[7],"故障部位","设备型号")
subclassRelationship(workSheetName[8],"故障部位","故障现象")
subclassRelationship(workSheetName[9],"故障现象","故障原因")
subclassRelationship(workSheetName[10],"故障原因","故障分类")
subclassRelationship(workSheetName[11],"故障类型","设备型号")
